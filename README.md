...
| **11** | **IEMS (Integrated Enterprise Management System)** 🏢 | Enterprise asset and maintenance management platform developed with a modern **N-Tier Architecture**. The system enables departments to manage assets, assignments, maintenance records, fault reports, suppliers, documents, and activity logs through a secure role-based administration panel. The MVC application communicates with the Web API using JWT authentication and follows clean architecture principles. | ASP.NET Core MVC, ASP.NET Core Web API, .NET, EF Core, Dapper, SQL Server, Repository Pattern, Unit of Work, AutoMapper, FluentValidation, ASP.NET Core Identity, JWT Authentication, Serilog, QuestPDF, EPPlus, N-Tier Architecture | 📁 [https://github.com/sumeyyegnc/IEMS](https://github.com/sumeyyegnc/IEMS) |
